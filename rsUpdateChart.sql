...
INSERT INTO `tbl_obat` (`id`, `nama_obat`, `harga`, `kategori_obat`, `satuan_barang`) VALUES
('2', 'BETADIN', 45000, 'Obat Antibiotik', 'Sirup'),
('4', 'Mixagrip flu dan batuk', 5000, 'Obat Vitamin', 'Tablet'),
('5', 'Panadol', 5000, 'Obat Vitamin', 'Tablet');
...
(5, 'Alifa Diena ', '1998-08-21', 'p', 'Jakarta Selatan, Jakarta', '085375065169', 'RM-1604205359');
...
('2', 'Alifa Diena', 'RM-1604205359', 'Badan Meriang', '1', 'Berikan obat meriang', 'Berikan obat meriang', '2020-06-20', 'selesai', '200000');
...
CREATE TABLE `tbl_riwayat_pemberian_obat` (
  ...
  `status_resep` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_riwayat_pemberian_obat` (`id`, `id_data_pemeriksaan`, `kode_barang`, `qty`, `tanggal`, `status`, `status_resep`) VALUES
(1, '1', '5', 1, '2020-06-12 15:50:16', 'ready', 'COMPLETE'),
(4, '1', '4', 4, '2020-06-19 02:39:26', 'ready', 'COMPLETE'),
(5, '1', '2', 1, '2020-06-19 02:43:56', 'ready', 'COMPLETE'),
(6, '2', '5', 2, '2020-06-24 16:24:23', 'ready', 'COMPLETE'),
(7, '2', '4', 5, '2020-06-24 16:24:37', 'ready', 'COMPLETE');
...
(6, 'ADMUSR1', 'sarah@email.com', '21232f297a57a5a743894a0e4a801fc3', '2020-06-24 21:17:59', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00', '', 1, 'aktif', 'Sarah Nur Laila', ''),
